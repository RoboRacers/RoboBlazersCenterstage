...
@TeleOp(name="Pixel Detect by Shape Tape Remove OpMode", group="Linear Opmode")
public class PixelDetectionByTapeRemoveOpmode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //telemetry.update();
        PixelDetectionByTapeRemove myPixelDetectionByTapeRemove = new PixelDetectionByTapeRemove(camera, telemetry);
        ...
        while (opModeIsActive()) {
            ...
            //telemetry.update();
            pixelCenterX = myPixelDetectionByTapeRemove.getCenterX();
            pixelCenterY = myPixelDetectionByTapeRemove.getCenterY();
