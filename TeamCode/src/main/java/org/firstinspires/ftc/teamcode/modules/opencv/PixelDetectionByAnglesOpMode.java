...
@TeleOp(name="Pixel Detection by Angles", group="Linear Opmode")
public class PixelDetectionByAnglesOpMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        PixelDetectionByAnglesPipeline myPixelDetection = new PixelDetectionByAnglesPipeline(camera, telemetry);
